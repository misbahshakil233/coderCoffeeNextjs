...
const About = () => {
  return (
    <section 
      id="about" 
      className="relative min-h-screen p-12 text-gray-800 flex flex-col items-center justify-center"
      style={{ 
        backgroundImage: "url('https://images.unsplash.com/photo-1511920170033-f8396924c348?crop=entropy&fit=crop&w=1200&q=80')", 
        backgroundSize: 'cover', 
        backgroundPosition: 'center', 
        backgroundAttachment: 'fixed',
        backgroundColor: 'rgba(0, 0, 0, 0.5)', // Black overlay for text readability
    ...
    >
      ...
      <div className="mt-44 text-center w-full max-w-5xl">
        <h1 className="text-5xl font-extrabold text-white mb-10 tracking-tight">About Us</h1>
        <p className="text-xl mb-12 max-w-4xl mx-auto text-white font-semibold">
        ...
        <div className="grid md:grid-cols-3 gap-10 text-left">
          {/* Story Section */}
          <div className="bg-white bg-opacity-90 rounded-lg shadow-lg p-6 hover:shadow-xl transform hover:scale-105 transition-all duration-300">
